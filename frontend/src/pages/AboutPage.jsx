  ...
  return (
    <main className="bg-background text-primary min-h-screen">
      ...
      <section className="px-10 py-20 border-b border-primary/10">
        ...
        <h1 className="font-display text-[80px] md:text-[120px] leading-[0.88] tracking-[0.02em] max-w-[900px]">
      ...
      <section className="grid md:grid-cols-2 border-b border-primary/10">
        <div className="px-10 py-16 border-r border-primary/10">
          <p className="text-[10px] font-bold tracking-[0.3em] text-muted uppercase mb-6">The Origin</p>
          <p className="text-[15px] text-primary/80 leading-relaxed tracking-[0.03em] mb-5">
          ...
          <p className="text-[15px] text-muted leading-relaxed tracking-[0.03em]">
            So we built it. Starting with one hoodie, one drop, and a frequency that people felt before they even saw the logo.
          </p>
        </div>
        <div className="px-10 py-16">
          <p className="text-[10px] font-bold tracking-[0.3em] text-muted uppercase mb-6">The Mission</p>
          <p className="text-[15px] text-primary/80 leading-relaxed tracking-[0.03em] mb-5">
      ...
      <section className="px-10 py-16 border-b border-primary/10">
        <p className="text-[10px] font-bold tracking-[0.3em] text-muted uppercase mb-12">What We Stand For</p>
        <div className="grid md:grid-cols-3 gap-px bg-primary/8">
          {values.map(v => (
            <div key={v.number} className="bg-background p-8">
              <p className="font-display text-[40px] text-primary/15 leading-none mb-6">{v.number}</p>
              <h3 className="font-display text-[22px] tracking-[0.06em] mb-4">{v.title}</h3>
              <p className="text-[13px] text-muted leading-relaxed tracking-[0.03em]">{v.body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="px-10 py-24 border-b border-primary/10">
        <h2 className="font-display text-[56px] md:text-[88px] leading-[0.9] tracking-[0.02em] max-w-[820px] mb-12">
